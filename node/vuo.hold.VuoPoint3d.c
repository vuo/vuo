/**
 * @file
 * vuo.hold.VuoPoint3d node implementation.
 *
...
(
		...
		VuoInputData(VuoPoint3d, {"default":{"x":0,"y":0,"z":0}}) initialValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,initialValue) initialValueEvent,
		VuoInputData(VuoPoint3d, {"default":{"x":0,"y":0,"z":0}}) newValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,newValue) newValueEvent,
		VuoOutputData(VuoPoint3d) heldValue
)
{
	if (newValueEvent)
