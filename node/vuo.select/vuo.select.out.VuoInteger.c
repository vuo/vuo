/**
 * @file
 * vuo.select.out.VuoInteger node implementation.
 *
...
(
		...
		VuoInputData(VuoInteger, {"default":0}) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoInteger) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoInteger) trueOption,
