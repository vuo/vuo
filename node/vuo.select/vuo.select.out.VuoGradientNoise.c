/**
 * @file
 * vuo.select.out.VuoGradientNoise node implementation.
 *
...
(
		...
		VuoInputData(VuoGradientNoise) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoGradientNoise) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoGradientNoise) trueOption,
