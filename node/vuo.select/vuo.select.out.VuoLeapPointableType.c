/**
 * @file
 * vuo.select.out.VuoLeapPointableType node implementation.
 *
...
(
		...
		VuoInputData(VuoLeapPointableType) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoLeapPointableType) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoLeapPointableType) trueOption,
