/**
 * @file
 * vuo.select.latest.2.VuoMouseButtonAction node implementation.
 *
...
void nodeEvent
(
		VuoInputData(VuoMouseButtonAction) option1,
		VuoInputEvent(VuoPortEventBlocking_None,option1) option1Event,
		VuoInputData(VuoMouseButtonAction) option2,
		VuoInputEvent(VuoPortEventBlocking_None,option2) option2Event,
		VuoOutputData(VuoMouseButtonAction) latest
)
{
