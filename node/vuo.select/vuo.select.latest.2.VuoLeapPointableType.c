/**
 * @file
 * vuo.select.latest.2.VuoLeapPointableType node implementation.
 *
...
void nodeEvent
(
		VuoInputData(VuoLeapPointableType) option1,
		VuoInputEvent(VuoPortEventBlocking_None,option1) option1Event,
		VuoInputData(VuoLeapPointableType) option2,
		VuoInputEvent(VuoPortEventBlocking_None,option2) option2Event,
		VuoOutputData(VuoLeapPointableType) latest
)
{
