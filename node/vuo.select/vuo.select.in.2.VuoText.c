/**
 * @file
 * vuo.select.in.2.VuoText node implementation.
 *
...
VuoModuleMetadata({
					 ...
					 "description" :
						...
						If `which` is 1 (or less), it selects `option1`. If `which` is 2 (or more), it selects `option2`.</pr> \
