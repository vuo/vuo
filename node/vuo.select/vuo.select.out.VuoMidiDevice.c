/**
 * @file
 * vuo.select.out.VuoMidiDevice node implementation.
 *
...
(
		...
		VuoInputData(VuoMidiDevice) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoMidiDevice) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoMidiDevice) trueOption,
