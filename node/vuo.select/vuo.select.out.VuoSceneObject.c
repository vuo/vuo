/**
 * @file
 * vuo.select.out.VuoSceneObject node implementation.
 *
...
(
		...
		VuoInputData(VuoSceneObject) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoSceneObject) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoSceneObject) trueOption,
