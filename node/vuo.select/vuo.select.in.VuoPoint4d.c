/**
 * @file
 * vuo.select.in.VuoPoint4d node implementation.
 *
...
(
		...
		VuoInputData(VuoPoint4d, {"default":{"x":0,"y":0,"z":0,"w":0}}) falseOption,
		VuoInputEvent(VuoPortEventBlocking_Door,falseOption) falseOptionEvent,
		VuoInputData(VuoPoint4d, {"default":{"x":0,"y":0,"z":0,"w":0}}) trueOption,
		VuoInputEvent(VuoPortEventBlocking_Door,trueOption) trueOptionEvent,
		VuoOutputData(VuoPoint4d) out,
