/**
 * @file
 * vuo.select.out.VuoCurveDomain node implementation.
 *
...
(
		...
		VuoInputData(VuoCurveDomain) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoCurveDomain) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoCurveDomain) trueOption,
