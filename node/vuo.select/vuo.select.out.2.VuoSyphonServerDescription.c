/**
 * @file
 * vuo.select.out.2.VuoSyphonServerDescription node implementation.
 *
...
(
		...
		VuoOutputData(VuoSyphonServerDescription) option1,
		VuoOutputEvent(option1) option1Event,
		VuoOutputData(VuoSyphonServerDescription) option2,
