/**
 * @file
 * vuo.select.out.VuoCountWrapMode node implementation.
 *
...
(
		...
		VuoInputData(VuoCountWrapMode) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoCountWrapMode) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoCountWrapMode) trueOption,
