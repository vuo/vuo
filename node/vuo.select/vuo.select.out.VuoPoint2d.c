/**
 * @file
 * vuo.select.out.pointed node implementation.
 *
...
(
		...
		VuoInputData(VuoPoint2d, {"default":{"x":0,"y":0}}) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoPoint2d) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoPoint2d) trueOption,
