/**
 * @file
 * vuo.select.out.VuoFrameRequest node implementation.
 *
...
(
		...
		VuoInputData(VuoFrameRequest) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoFrameRequest) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoFrameRequest) trueOption,
