/**
 * @file
 * vuo.select.out.VuoMidiController node implementation.
 *
...
(
		...
		VuoInputData(VuoMidiController) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoMidiController) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoMidiController) trueOption,
