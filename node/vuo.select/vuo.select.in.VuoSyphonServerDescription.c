/**
 * @file
 * vuo.select.in.VuoSyphonServerDescription node implementation.
 *
...
(
		...
		VuoInputData(VuoSyphonServerDescription) falseOption,
		VuoInputEvent(VuoPortEventBlocking_Door,falseOption) falseOptionEvent,
		VuoInputData(VuoSyphonServerDescription) trueOption,
		VuoInputEvent(VuoPortEventBlocking_Door,trueOption) trueOptionEvent,
		VuoOutputData(VuoSyphonServerDescription) out,
