/**
 * @file
 * vuo.select.out.VuoSyphonServerDescription node implementation.
 *
...
(
		...
		VuoInputData(VuoSyphonServerDescription) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoSyphonServerDescription) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoSyphonServerDescription) trueOption,
