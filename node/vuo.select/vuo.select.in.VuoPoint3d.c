/**
 * @file
 * vuo.select.in.VuoPoint3d node implementation.
 *
...
(
		...
		VuoInputData(VuoPoint3d, {"default":{"x":0,"y":0,"z":0}}) falseOption,
		VuoInputEvent(VuoPortEventBlocking_Door,falseOption) falseOptionEvent,
		VuoInputData(VuoPoint3d, {"default":{"x":0,"y":0,"z":0}}) trueOption,
		VuoInputEvent(VuoPortEventBlocking_Door,trueOption) trueOptionEvent,
		VuoOutputData(VuoPoint3d) out,
