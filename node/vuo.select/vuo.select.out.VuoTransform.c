/**
 * @file
 * vuo.select.out.VuoTransform node implementation.
 *
...
(
		...
		VuoInputData(VuoTransform) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoTransform) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoTransform) trueOption,
