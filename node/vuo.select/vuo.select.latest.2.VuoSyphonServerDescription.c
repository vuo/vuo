/**
 * @file
 * vuo.select.latest.2.VuoSyphonServerDescription node implementation.
 *
...
void nodeEvent
(
		VuoInputData(VuoSyphonServerDescription) option1,
		VuoInputEvent(VuoPortEventBlocking_None,option1) option1Event,
		VuoInputData(VuoSyphonServerDescription) option2,
		VuoInputEvent(VuoPortEventBlocking_None,option2) option2Event,
		VuoOutputData(VuoSyphonServerDescription) latest
)
{
