/**
 * @file
 * vuo.select.out.VuoMouseButtonAction node implementation.
 *
...
(
		...
		VuoInputData(VuoMouseButtonAction) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoMouseButtonAction) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoMouseButtonAction) trueOption,
