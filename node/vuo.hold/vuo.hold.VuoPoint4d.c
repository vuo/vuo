/**
 * @file
 * vuo.hold.VuoPoint4d node implementation.
 *
...
VuoModuleMetadata({
					 ...
					 "keywords" : [ "store", "sample", "feedback" ],
					 "version" : "1.0.0",
					 "node": {
						 "isInterface" : false
					 }
...
(
		...
		VuoInputData(VuoPoint4d, {"default":{"x":0,"y":0,"z":0,"w":0}}) initialValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,initialValue) initialValueEvent,
		VuoInputData(VuoPoint4d, {"default":{"x":0,"y":0,"z":0,"w":0}}) newValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,newValue) newValueEvent,
		VuoOutputData(VuoPoint4d) heldValue
)
{
	if (newValueEvent)
