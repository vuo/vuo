/**
 * @file
 * vuo.hold.VuoSyphonServerDescription node implementation.
 *
...
(
		...
		VuoInputData(VuoSyphonServerDescription) initialValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,initialValue) initialValueEvent,
		VuoInputData(VuoSyphonServerDescription) newValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,newValue) newValueEvent,
		VuoOutputData(VuoSyphonServerDescription) heldValue
)
{
	if (newValueEvent)
