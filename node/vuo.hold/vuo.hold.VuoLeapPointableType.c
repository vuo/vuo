/**
 * @file
 * vuo.hold.VuoLeapPointableType node implementation.
 *
...
(
		...
		VuoInputData(VuoLeapPointableType) initialValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,initialValue) initialValueEvent,
		VuoInputData(VuoLeapPointableType) newValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,newValue) newValueEvent,
		VuoOutputData(VuoLeapPointableType) heldValue
)
{
	if (newValueEvent)
