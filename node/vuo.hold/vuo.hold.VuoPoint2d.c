/**
 * @file
 * vuo.hold.VuoPoint2d node implementation.
 *
...
(
		...
		VuoInputData(VuoPoint2d, {"default":{"x":0,"y":0}}) initialValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,initialValue) initialValueEvent,
		VuoInputData(VuoPoint2d, {"default":{"x":0,"y":0}}) newValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,newValue) newValueEvent,
		VuoOutputData(VuoPoint2d) heldValue
)
{
	if (newValueEvent)
