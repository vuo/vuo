/**
 * @file
 * vuo.select.out.VuoLeapFrame node implementation.
 *
...
(
		...
		VuoInputData(VuoLeapFrame) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoLeapFrame) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoLeapFrame) trueOption,
