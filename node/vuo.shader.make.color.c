...
VuoModuleMetadata({
					 ...
					 "description" :
						 "<p>Creates a graphics shader that can paint a 3D object with a solid color.</p> \
						 <p>This shader ignores lighting. It makes a 3D object look like a flat 2D object.</p>",
