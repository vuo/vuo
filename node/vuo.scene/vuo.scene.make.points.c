	...
	VuoOutputData(VuoSceneObject) object)
{
	...
	if (VuoListGetCount_VuoGenericType1(positions) < 1)
	{
		*object = NULL;
	...
	VuoMesh mesh = VuoMesh_make_VuoGenericType1(positions, colors, VuoMesh_Points, pointSize);
