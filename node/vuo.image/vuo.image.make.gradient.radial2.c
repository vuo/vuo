...
{
	VuoPoint2d scaledCenter = center;
	scaledCenter.y *= (float)width/height;

	VuoShader_setRadialGradientShaderValues((*instance)->shader, colors, scaledCenter, radius, width, height, noiseAmount);
