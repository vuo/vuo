...
)
{
	...
	VuoShader_setUniformFloatArray(verticalPassShader, (*instance)->glContext, "offset", offset, 3);
	VuoShader_setUniformFloatArray(verticalPassShader, (*instance)->glContext, "weight", weight, 3);

	VuoShader_setUniformFloatArray(horizontalPassShader, (*instance)->glContext, "offset", offset, 3);
	VuoShader_setUniformFloatArray(horizontalPassShader, (*instance)->glContext, "weight", weight, 3);
	...
	for(int i = 0; i < radius; i++)
	{
		...
		img = VuoImageRenderer_draw((*instance)->imageRenderer, horizontalPassShader, w, h);
	}
