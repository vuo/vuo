/**
 * @file
 * vuo.select.out.VuoPoint3d node implementation.
 *
...
(
		...
		VuoInputData(VuoPoint3d, {"default":{"x":0,"y":0,"z":0}}) in,
		VuoInputEvent(VuoPortEventBlocking_Door,in) inEvent,
		VuoOutputData(VuoPoint3d) falseOption,
		VuoOutputEvent(falseOption) falseOptionEvent,
		VuoOutputData(VuoPoint3d) trueOption,
