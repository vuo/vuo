/**
 * @file
 * vuo.hold.VuoMouseButtonAction node implementation.
 *
...
(
		...
		VuoInputData(VuoMouseButtonAction) initialValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,initialValue) initialValueEvent,
		VuoInputData(VuoMouseButtonAction) newValue,
		VuoInputEvent(VuoPortEventBlocking_Wall,newValue) newValueEvent,
		VuoOutputData(VuoMouseButtonAction) heldValue
)
{
	if (newValueEvent)
