/**
 * @file
 * vuo.list.count.VuoSyphonServerDescription node implementation.
 *
...
void nodeEvent
(
		VuoInputData(VuoList_VuoSyphonServerDescription) list,
		VuoOutputData(VuoInteger) itemCount
)
{
	*itemCount = VuoListGetCount_VuoSyphonServerDescription(list);
}
