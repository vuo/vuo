/**
 * @file
 * vuo.select.latest.2.VuoPoint4d node implementation.
 *
...
void nodeEvent
(
		VuoInputData(VuoPoint4d, {"default":{"x":0,"y":0,"z":0,"w":0}}) option1,
		VuoInputEvent(VuoPortEventBlocking_None,option1) option1Event,
		VuoInputData(VuoPoint4d, {"default":{"x":0,"y":0,"z":0,"w":0}}) option2,
		VuoInputEvent(VuoPortEventBlocking_None,option2) option2Event,
		VuoOutputData(VuoPoint4d) latest
)
{
