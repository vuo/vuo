...
class VuoConan(ConanFile):
    ...
    def requirements(self):
        self.requires('blackmagic/12.4.2-0@vuo+conan+blackmagic/stable')
        ...
        self.requires('freeimage/3.19.0-0@vuo+conan+freeimage/stable')
        ...
        self.requires('jsonc/0.16-0@vuo+conan+jsonc/stable')
        ...
        self.requires('llvm/5.0.2-7@vuo+conan+llvm/stable')
        self.requires('muparser/2.3.2-0@vuo+conan+muparser/stable')
        self.requires('ndi/5.5.3-0@vuo+conan+ndi/stable')
        ...
        self.requires('wuquant/2.0.0-2@vuo+conan+wuquant/stable')
