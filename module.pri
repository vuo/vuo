...
VUOCOMPILE_NODE_INCLUDEPATH = \
	$$MODULE_INCLUDEPATH \
	$$NODE_INCLUDEPATH
VUOCOMPILE_NODE_INCLUDEPATH_LOCAL = $$VUOCOMPILE_NODE_INCLUDEPATH
VUOCOMPILE_NODE_INCLUDEPATH_LOCAL -= $$find(VUOCOMPILE_NODE_INCLUDEPATH_LOCAL, Cellar)
VUOCOMPILE_NODE_DEPEND_FLAGS = \
	$$join(VUOCOMPILE_NODE_INCLUDEPATH_LOCAL, " -I", "-I")
...
VUOCOMPILE_TYPE_INCLUDEPATH = \
	...
	$$JSONC_ROOT/include \
	$$TYPE_INCLUDEPATH
VUOCOMPILE_TYPE_INCLUDEPATH_LOCAL = $$VUOCOMPILE_TYPE_INCLUDEPATH
VUOCOMPILE_TYPE_INCLUDEPATH_LOCAL -= $$find(VUOCOMPILE_TYPE_INCLUDEPATH_LOCAL, Cellar)
VUOCOMPILE_TYPE_DEPEND_FLAGS = \
	$$join(VUOCOMPILE_TYPE_INCLUDEPATH_LOCAL, " -I", "-I")
...
CLANG_NODE_LIBRARY_INCLUDEPATH_LOCAL = $$CLANG_NODE_LIBRARY_INCLUDEPATH
CLANG_NODE_LIBRARY_INCLUDEPATH_LOCAL -= $$find(CLANG_NODE_LIBRARY_INCLUDEPATH_LOCAL, Cellar)
CLANG_NODE_LIBRARY_DEPEND_FLAGS = $$join(CLANG_NODE_LIBRARY_INCLUDEPATH_LOCAL, " -I", "-I")

CLANG_NODE_LIBRARY_FLAGS += $$join(CLANG_NODE_LIBRARY_INCLUDEPATH, " -I", "-I")
...
node_library.depend_command = $$QMAKE_CC -nostdinc -MM -MF - -MG $$QMAKE_CFLAGS_X86_64 $$CLANG_NODE_LIBRARY_DEPEND_FLAGS ${QMAKE_FILE_NAME} | sed \"s,^.*: ,,\"
