...
void VuoNodePopover::initialize()
{
	...
	connect(headerLabel, &QLabel::linkHovered, this, &VuoNodePopover::linkHovered);
	...
	connect(textLabel, &QLabel::linkHovered, this, &VuoNodePopover::linkHovered);
	...
	if (displayModelNode)
	{
		...
		modelNodeView->setToolTip(tr("Drag this onto the canvas to add it to your composition."));
	}
