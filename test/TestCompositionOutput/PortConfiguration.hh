...
public:
	...
	void checkOutputValue(VuoRunner::Port *port, string value);
	bool isDoneChecking(void);
	static void readValueForPortNameFromJSONObject(json_object *valueForPortListObject, map<string, string> &valueForPort);
