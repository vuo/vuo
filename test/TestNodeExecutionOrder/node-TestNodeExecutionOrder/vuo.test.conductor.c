...
(
		...
		VuoInputEvent(VuoPortEventBlocking_None,triggerInfoIn0) triggerInfoEvent0,
		VuoInputEvent(VuoPortEventBlocking_None,triggerInfoIn1) triggerInfoEvent1,
		VuoInputEvent(VuoPortEventBlocking_None,triggerInfoIn2) triggerInfoEvent2,
		VuoInputEvent(VuoPortEventBlocking_None,triggerInfoIn3) triggerInfoEvent3,
