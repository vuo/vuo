...
typedef void (*VuoGraphicsWindowShowedWindowCallback)(VuoWindowReference window);                 ///< Called when the window is shown, moved, or resized.
...
@property(atomic) VuoGraphicsWindowShowedWindowCallback showedWindow;     ///< Callback to invoke when the window is shown, moved, and resized.
