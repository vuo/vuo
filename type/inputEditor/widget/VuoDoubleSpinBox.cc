 ...
 *
 * @version200Changed{Added `precision` argument.}
 */
VuoDoubleSpinBox::VuoDoubleSpinBox(QWidget *parent, int precision)
...
{
	QString newLineEditText = QLocale().toString(value, 'g', precision);
