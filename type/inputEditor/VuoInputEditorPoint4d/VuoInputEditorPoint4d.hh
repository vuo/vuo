...
#ifndef VUOINPUTEDITORPOINT4D_HH
#define VUOINPUTEDITORPOINT4D_HH
...
/**
 * A VuoInputEditorPoint4d factory.
 */
class VuoInputEditorPoint4dFactory : public VuoInputEditorFactory
{
   Q_OBJECT
   Q_PLUGIN_METADATA(IID "org.vuo.inputEditor" FILE "VuoInputEditorPoint4d.json")
...
/**
 * An input editor that displays widgets for editing a VuoPoint4d value,
 ...
 * }
 */
class VuoInputEditorPoint4d : public VuoInputEditorWithDialog
{
	Q_OBJECT
...
private:
	...
	VuoPoint4d current;							///< The current value.
...
#endif // VUOINPUTEDITORPOINT4D_HH
