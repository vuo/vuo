...
TARGET = VuoInputEditorBlackmagicInputDevice

include(../../../vuo.pri)

SOURCES +=\
	VuoInputEditorBlackmagicInputDevice.cc

HEADERS += \
	VuoInputEditorBlackmagicInputDevice.hh

OTHER_FILES += \
	VuoInputEditorBlackmagicInputDevice.json
