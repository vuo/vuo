...
\newcommand{\noteQCUsers}[1]{
	\marginpar{
		\begin{tikzpicture}
			...
			\node[sideboxtitle, right=10pt] at (box.north west) {\raisebox{-2.5mm}{\includegraphics[width=7mm,height=7mm]{image/Magic_Wand.pdf}} \parbox{31mm}{\footnotesize Note for\\Quartz Composer users}};
		\end{tikzpicture}%
	}
}
